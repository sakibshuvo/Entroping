...
- `scripts/regression.sh --security`: 393 passed; Bandit and default/all-extras dependency audits passed.
- `scripts/audit_quality.sh`: 393 passed with 86.85 percent total coverage; Radon and Vulture gates passed.
