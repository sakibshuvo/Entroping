...
- `scripts/regression.sh --security`: 410 passed; Bandit and default/all-extras dependency audits passed.
- `scripts/audit_quality.sh`: 410 passed with 87.37 percent total coverage; Radon and Vulture gates passed.
