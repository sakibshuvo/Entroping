...
- `scripts/regression.sh --security`: 447 passed; Bandit and default/all-extras dependency audits passed.
- `scripts/audit_quality.sh`: 447 passed with 88.18 percent total coverage; Radon and Vulture gates passed.
