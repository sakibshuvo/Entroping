...
- `scripts/regression.sh --security`: 404 passed; Bandit and default/all-extras dependency audits passed.
- `scripts/audit_quality.sh`: 404 passed with 87.12 percent total coverage; Radon and Vulture gates passed.
