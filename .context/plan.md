...
- `scripts/regression.sh --security`: 436 passed; Bandit and default/all-extras dependency audits passed.
- `scripts/audit_quality.sh`: 436 passed with 88.01 percent total coverage; Radon and Vulture gates passed.
