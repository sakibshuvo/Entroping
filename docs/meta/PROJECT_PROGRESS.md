...
| [Architect refactor preview](https://github.com/sakibshuvo/Entroping/issues/419) / [#599](https://github.com/sakibshuvo/Entroping/issues/599) | Done | `entroping architect refactor --preview` validates provider edits through the same managed-block merge and Hurl parser path as write mode, prints a redacted unified diff, writes value-free source evidence in the agent manifest, and leaves target Hurl files unchanged. |
