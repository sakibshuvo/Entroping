...
| Coverage Hardening | Current | 100 percent meaningful coverage is tracked in issue #112; `core.session_prompt`, `core.openapi_loader`, `core.hurl_validator`, `brain.output_parser`, and `bridge.merge` now have 100 percent module coverage | Burn down high-missing modules without gaming coverage |
