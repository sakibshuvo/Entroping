...
| [Architect refactor preview](https://github.com/sakibshuvo/Entroping/issues/419) / [#599](https://github.com/sakibshuvo/Entroping/issues/599) / [#598](https://github.com/sakibshuvo/Entroping/issues/598) | Done | Architect preview writes value-free source evidence and leaves target Hurl files unchanged; Hurl auth-chain metadata now records value-free flow IDs plus required/produced variable names in dry-run plans and JSON/JUnit/HTML reports while env values remain outside reports. |
