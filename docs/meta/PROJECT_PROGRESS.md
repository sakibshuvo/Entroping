...
| [Factory Python3 compatibility and worker file-safety](https://github.com/sakibshuvo/Entroping/issues/658) / [#661](https://github.com/sakibshuvo/Entroping/issues/661) / [#663](https://github.com/sakibshuvo/Entroping/issues/663) / [#665](https://github.com/sakibshuvo/Entroping/issues/665) / [#659](https://github.com/sakibshuvo/Entroping/issues/659) / [#673](https://github.com/sakibshuvo/Entroping/issues/673) / [#677](https://github.com/sakibshuvo/Entroping/issues/677) | Done / Follow-up queued | Factory metrics, graph probe, AI queue, OpenCode worker, and DeepSeek worker entrypoints avoid evaluated Python 3.10+/3.11-only APIs under host `python3`; OpenCode/DeepSeek selected-file preflight rejects sensitive paths, shell-style secrets, and quoted JSON credential assignments before provider review, OpenCode reviews use vetted snapshots instead of live selected-file reads, and OpenCode subprocess scratch writes stay separate from parent-owned artifact files; optional proxy-stack Tornado keeps a temporary `>=6.5.6` uv override until mitmproxy relaxes its cap. |
