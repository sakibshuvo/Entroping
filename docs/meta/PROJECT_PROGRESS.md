...
| [Policy-pack smoke evidence](https://github.com/sakibshuvo/Entroping/issues/287) | Done | `scripts/policy_pack_smoke.py --strict` validates the example API-baseline pack manifest, entrypoint, imported gates, final gates, and consumer evidence through local QAnstitution imports | Keep policy-pack claims local and artifact-backed before registries or install commands |
