...
| [Tier A worktree orchestration](https://github.com/sakibshuvo/Entroping/issues/1574) | In progress | Pre-merge maintainer adapter binds scheduler ownership and exact proposal bytes to one canonical issue worktree, allowlisted gates, a private lifecycle journal, and value-free revision receipts. It is not release evidence. |
