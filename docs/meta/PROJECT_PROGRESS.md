...
| [Traffic-to-Hurl compiler](https://github.com/sakibshuvo/Entroping/issues/67) | Next | Compile redacted sessions into valid Hurl content | Depends on #66 |
...
| Freeze and Map | Current | Filtering/session bridge is in place; next slice is redacted traffic-to-Hurl compilation |
