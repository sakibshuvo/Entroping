...
| [Lossless decision registry](https://github.com/sakibshuvo/Entroping/issues/468) / [#602](https://github.com/sakibshuvo/Entroping/issues/602) / [#636](https://github.com/sakibshuvo/Entroping/issues/636) | Done | `docs/meta/DECISION_REGISTRY.yaml` indexes durable decisions, `scripts/context_pack.sh` surfaces the registry, graph/comprehension/compression tools remain optional evidence and economic aids, and Codex-owned issue worktrees plus tests, CI, ADRs, and QAnstitution/Hurl evidence stay authoritative. |
