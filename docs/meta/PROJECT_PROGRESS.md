...
| Launch Assets | Done | Text/SVG launch kit links real checkout demo output, report preview, and dependency map example from README and Obsidian index | Convert to external screenshots/video only after release evidence is current |
