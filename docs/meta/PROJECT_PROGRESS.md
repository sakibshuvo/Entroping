...
| [Deterministic support-module coverage](https://github.com/sakibshuvo/Entroping/issues/146) | Done | `core.dependency_mapper`, `core.drift_report`, `models.traffic`, and `studio.status` have 100 percent focused coverage | Continue issue #112 with Architect and Eye-heavy remaining gaps |
| [Eye proxy and freeze coverage](https://github.com/sakibshuvo/Entroping/issues/145) | Done | `core.traffic_proxy` and `core.freeze` have 100 percent focused coverage without live mitmproxy or network sessions | Continue issue #112 with Architect-heavy remaining gaps |
