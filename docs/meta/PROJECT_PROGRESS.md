...
| [Lossless decision registry](https://github.com/sakibshuvo/Entroping/issues/468) / [#602](https://github.com/sakibshuvo/Entroping/issues/602) / [#636](https://github.com/sakibshuvo/Entroping/issues/636) / [#650](https://github.com/sakibshuvo/Entroping/issues/650) | Done | `docs/meta/DECISION_REGISTRY.yaml` indexes durable decisions, `scripts/context_pack.sh` surfaces the registry, and optional `--with-local-graphs` probes can route agents toward local Graphify/CodeGraph file and test evidence while tests, CI, ADRs, and QAnstitution/Hurl evidence stay authoritative. |
