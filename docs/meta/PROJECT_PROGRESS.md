...
| --- | --- | --- |
| [Live factory issue selection](https://github.com/sakibshuvo/Entroping/issues/1567) | Pending merge | Read-only deterministic selection fails closed on stale GitHub, ownership, lease, overlap, dependency, or ambiguous issue-contract state and never authorizes paid work. |
