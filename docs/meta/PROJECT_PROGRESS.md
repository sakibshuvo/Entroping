...
| [JSON/JUnit reports](https://github.com/sakibshuvo/Entroping/issues/5) | Current | Report command scaffold exists | CI can consume JUnit and humans can inspect JSON |
