...
| [Provider scorecard evidence](https://github.com/sakibshuvo/Entroping/issues/1573) | In progress | Pre-merge repair is tightening HMAC-maintainer attestation, replay protection, per-case recency, cost binding, and typed value-free reports. It is not release evidence. |
