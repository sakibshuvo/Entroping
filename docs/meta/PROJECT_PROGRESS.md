...
| [Offline proposal-controller validation](https://github.com/sakibshuvo/Entroping/issues/1575) | Evidence complete (offline) | The bounded 15-test harness emitted 27 schema-version-1 value-free receipts, kept source/Git state stable, and measured 5.89s baseline / 6.134s repeated local mean. It intentionally excludes live GitHub selection, provider dispatch, orchestration apply, and launchd; #1576 remains the PR/CI/merge-control blocker. |
