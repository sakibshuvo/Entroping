...
| --- | --- | --- |
| [Atomic scheduler lease and concurrency authority](https://github.com/sakibshuvo/Entroping/issues/1569) | Pending merge | Shared Git-root SQLite authority serializes lease, capacity, and assignment evidence; paid ticks hold the separate ledger writer guard through scheduler commit, while PID/start-token and epoch fencing block duplicate or unsafe takeover without dispatching providers. |
