...
Current issue: [#400](https://github.com/sakibshuvo/Entroping/issues/400)
adds OpenAPI operation-to-Hurl coverage matrix evidence.
...
| --- | --- | --- |
| 1 | [#400](https://github.com/sakibshuvo/Entroping/issues/400) | Add OpenAPI operation-to-Hurl coverage matrix evidence. |
| 2 | [#401](https://github.com/sakibshuvo/Entroping/issues/401) | Add local policy-pack vendoring without remote registry coupling. |
| 3 | [#402](https://github.com/sakibshuvo/Entroping/issues/402) | Support named suite manifests from committed YAML. |
