...
| Agent Workflow | Done | Deterministic context packs, configurable source-archive paths, cross-agent control plane, source-promotion workflow, and community health docs are available | Use issue branches for follow-on automation |
