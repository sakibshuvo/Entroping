...
| `2` | CLI usage or unsupported-mode error. | Unknown commands, unsupported `architect build --strategy`, unsupported `report delta --output`, unsupported `report policy-diff --output`, unsupported `report redaction --output`, unsupported `report capture-summary --output`, unsupported `report gate-coverage --output`, invalid `report gate-coverage --fail-under`, unsupported `report test-quality --output`, invalid `report test-quality --fail-under`, unsupported `report test-pyramid --output`, unsupported `report external-test-evidence --output`, unsupported `report runtime-card --output`, unsupported `report handoff --output`, unsupported `report notification-packet --output`, unsupported `report team-evidence-readiness --output`, unsupported `report team-access-control-plan --output`, unsupported `report integration-readiness --output`, unsupported `report devex-readiness --output`, unsupported `report evidence-cloud-readiness --output`, unsupported `report connector-intent --output`, unsupported `report observability-packet --output`, unsupported `report api-inventory --output`, unsupported `report mutation-readiness --output`, unsupported `report evidence-index --output`, unsupported `report qa-brain-seed --output`, unsupported `report qa-brain-eval-plan --output`, unsupported `report qa-brain-retrieval-plan --output`, unsupported `report qa-brain-prompt-plan --output`, unsupported `report qa-brain-fine-tune-readiness --output`, unsupported `report qa-brain-model-packaging-plan --output`, unsupported `report qa-brain-routing-plan --output`, unsupported `report pilot-metrics --output`, unsupported `report agent-bundle --output`, unsupported `report agent-bundle --role`, unsupported `report traceability --output`, unsupported `report review-summary --output`, unsupported `run --report`. |
