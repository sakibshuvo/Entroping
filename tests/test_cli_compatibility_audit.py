...
LOCKED_CLI_CONTRACTS = (
    ...
    CliContract(
        ...
        ("report", "otel-mapping", "--help"),
        ("--output",),
    ),
    CliContract(
        "entroping report observability-adapter-readiness [--output <md|json>]",
        ("report", "observability-adapter-readiness", "--help"),
        ("--output",),
    ),
    CliContract(
...
REPORT_ARTIFACTS = (
    ...
    "reports/pilot-outcome.md",
    "reports/pilot-outcome.json",
    "reports/pilot-cohort.md",
    "reports/pilot-cohort.json",
    "reports/observability-packet.md",
    "reports/observability-packet.json",
    "reports/otel-mapping.md",
...
def test_report_schema_docs_include_observability_adapter_troubleshooting_matrix() -> None:
    report_schemas = (
